...
<div class="container">
    <div class="row">
    <div id="msg"></div>
        <form class="form" id="AjaxRequest" method="GET"> 

          <?php 
            foreach ($produtos2->toArray() as $key => $value) {
                          $valor='';
                          $nome='';
                          $rslt=0;
                          $tam=10;
                           ...
                           if ($rslt==0) {
                             echo ' <div class="form-group">
                              ...
                              echo ' <div class="form-group">
                                  <label for="'.$key.'" class="col-sm-2 control-label">'.$nome.'</label>
                                  <div class="col-sm-'.$tam.'">
                                  <textarea class="form-control" name="'.$key.'" '.$valor.' id="'.$key.'" rows="6">'.$value.'</textarea>
